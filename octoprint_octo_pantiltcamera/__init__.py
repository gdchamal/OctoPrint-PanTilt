...
class Octo_pantiltcameraPlugin(octoprint.plugin.SettingsPlugin,
    ...
    def get_assets(self):
        return dict(
            js=["js/octo_pantiltcamera.js"],
            css=["css/octo_pantiltcamera.css"],
            less=["less/octo_pantiltcamera.less"]
        )
